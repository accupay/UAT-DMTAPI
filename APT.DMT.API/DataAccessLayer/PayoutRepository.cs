...
namespace APT.DMT.API.DataAccessLayer.Paytout
{
    public class PayoutRepository
    {
        ...
        public DataSet PayoutFundTransfer(PayoutPaymentRequest Request)
        {
            using (var connections = new SqlConnection(_txnconnString))
            {
                connections.Open();
                using (var cmd = new SqlCommand("APT_TransferMoneyToPayee_Payout", connections))
                {
                    cmd.Parameters.Add(new SqlParameter("sendermobilenumber", Request.sendermobilenumber));
                    cmd.Parameters.Add(new SqlParameter("PayeeRefID", Request.PayeeRefID));
                    cmd.Parameters.Add(new SqlParameter("Amount", Request.Amount));
                    cmd.Parameters.Add(new SqlParameter("PaymentTransactionTypeRefID", Request.PaymentTransactionTypeRefID));
                    cmd.Parameters.Add(new SqlParameter("PayModeRefID", Request.PayModeRefID));
                    cmd.Parameters.Add(new SqlParameter("Agentmobile", Request.Agentmobile));
                    cmd.Parameters.Add(new SqlParameter("ifsccodein", Request.ifsccodein));
                    cmd.Parameters.Add(new SqlParameter("ChannelType", Request.ChannelType));
                    cmd.Parameters.Add(new SqlParameter("LATITUDE", Request.LATITUDE));
                    cmd.Parameters.Add(new SqlParameter("Longitude", Request.Longitude));
                    cmd.Parameters.Add(new SqlParameter("AgentRemarks", Request.AgentRemarks));
                    cmd.Parameters.Add(new SqlParameter("Remarks", Request.Remarks));
                    cmd.Parameters.Add(new SqlParameter("Accountnumerin", Request.Accountnumerin));
                    cmd.Parameters.Add(new SqlParameter("ARefID", Request.ARefID));
                    cmd.Parameters.Add(new SqlParameter("location_acquirace", Request.location_acquirace));
                    cmd.Parameters.Add(new SqlParameter("agent_ip", Request.agent_ip));
                    cmd.Parameters.Add(new SqlParameter("MacID", Request.MacID));
                    try
                    {
        ...
        public DataSet PayoutUpdateResponse(UpdateTxnStatusPayout Request)
        {
            using (var connections = new SqlConnection(_txnconnString))
            {
                connections.Open();
                using (var cmd = new SqlCommand("APT_Updatepaymenttransaction_Payout", connections))
                {
                    cmd.Parameters.Add(new SqlParameter("@TransactionID", Request.TransactionID));
                    cmd.Parameters.Add(new SqlParameter("@BankReferrenceNumber", Request.BankReferrenceNumber));
                    cmd.Parameters.Add(new SqlParameter("@Request", Request.Request));
                    cmd.Parameters.Add(new SqlParameter("@Response", Request.Response));
                    cmd.Parameters.Add(new SqlParameter("@ResponseCode", Request.ResponseCode));
                    cmd.Parameters.Add(new SqlParameter("@ResponseDescription", Request.ResponseDescription));
                    cmd.Parameters.Add(new SqlParameter("@TranStatus", Request.TranStatus));
                    cmd.Parameters.Add(new SqlParameter("@Flag", Request.Flag));
                    cmd.Parameters.Add(new SqlParameter("@BankTypeID", Request.BankTypeID));
        ...
        public DataSet PayoutCheckStatus(PayoutStatusRequest Request)
        {
            using (var connections = new SqlConnection(_txnconnString))
            {
                connections.Open();
                using (var cmd = new SqlCommand("APT_Getpaymenttransaction_Payout", connections))
                {
                    cmd.Parameters.Add(new SqlParameter("transactionID", Request.transactionID));
                    try
                    {
        ...
        public DataSet PayoutYesBankUpdateBeneName(APTUpdateBeneNameYesbank_payout Request)
        {
            using (var connections = new SqlConnection(_txnconnString))
            {
                connections.Open();
                using (var cmd = new SqlCommand("APTPAYOUTUPDATE_YESBANK", connections))
                {
                    cmd.Parameters.Add(new SqlParameter("@Transactionid", Request.transaction_id));
                    cmd.Parameters.Add(new SqlParameter("@rrn", Request.rrn));
                    cmd.Parameters.Add(new SqlParameter("@Benename", Request.bene_name));
                    cmd.Parameters.Add(new SqlParameter("@StatusUpdateDateTime", Request.status_update_datetime));
        ...
        public DataSet APTGetCustomerInfo(APTGetCustomerInfo Request)
        {
            ...
            {
                connection.Open();
                using (var cmd = new SqlCommand("APT_GetCustomerInfo_payout", connection))
                {
        ...
        public DataSet APTRegisterCustomer(APTRegisterCustomer Request)
        {
            ...
            {
                connection.Open();
                using (var cmd = new SqlCommand("APT_RegisterCustomer_payout", connection))
                {
                    cmd.Parameters.Add(new SqlParameter("MobileNo", Request.mobile_no));
        ...
        public DataSet APTUpdateCustomer(APTUpdateCustomerRequest Request)
        {
            ...
            {
                connection.Open();
                using (var cmd = new SqlCommand("APT_UpdateCustomer_payout", connection))
                {
                    cmd.Parameters.Add(new SqlParameter("MobileNo", Request.mobile_no));
        ...
        public DataSet APTInsertOTP(APTInsertOTPRequest Request)
        {
            ...
            {
                connection.Open();
                using (var cmd = new SqlCommand("APT_insotp_payout", connection))
                {
        ...
        public DataSet APTRegisterCustomerWithID(APTRegisterCustomer Request)
        {
            ...
            {
                connection.Open();
                using (var cmd = new SqlCommand("APT_RegisterCustomer_withid_registration_payout", connection))
                {
                    cmd.Parameters.Add(new SqlParameter("MobileNo", Request.mobile_no));
                    cmd.Parameters.Add(new SqlParameter("AgentMobile", Request.agent_mobile_no));
                    cmd.Parameters.Add(new SqlParameter("CustomerName", Request.customer_name));
        ...
        public DataSet APTValidateRegisterCustomerOTP(ValidateOTPRequest Request)
        {
            ...
            {
                connection.Open();
                using (var cmd = new SqlCommand("ValidateOTP_payout", connection))
                {
        ...
        public DataSet APTGetAllPayee(APTGetAllPayee Request)
        {
            ...
            {
                connection.Open();
                using (var cmd = new SqlCommand("APT_GetAllPayee_payout_v1", connection))
                {
        ...
        public DataSet APTGetPayeeDetails(string PayeeRefID, string CustMobNum)
        {
            ...
            {
                connection.Open();
                using (var cmd = new SqlCommand("APT_GetPayeeDetails_payout", connection))
                {
        ...
        public DataSet APTAddPayee(APTAddPayee Request)
        {
            ...
            {
                connection.Open();
                using (var cmd = new SqlCommand("APT_AddPayee_payout", connection))
                {
        ...
        public DataSet APTDeletePayee(APTDeletePayee Request)
        {
            ...
            {
                connection.Open();
                using (var cmd = new SqlCommand("APT_DeletePayee_payout", connection))
                {
                    cmd.Parameters.Add(new SqlParameter("Payeerefid", Convert.ToInt32(Request.payee_ref_id)));
        ...
        public DataSet APTAddPayeeWithID(APTAddPayee Request)
        {
            ...
            {
                connection.Open();
                using (var cmd = new SqlCommand("APT_AddPayee_withid_registration_payout", connection))
                {
        ...
        public DataSet APTUpdatePayee(APTUpdatePayeeRequest Request)
        {
            ...
            {
                connection.Open();
                using (var cmd = new SqlCommand("APT_UpdatePAyee_payout", connection))
                {
        ...
        public DataSet APTUpdateBeneValidationStatus(APTUpdatePayeeRequest Request)
        {
            ...
            {
                connection.Open();
                using (var cmd = new SqlCommand("APT_UpdateNPCIName_payout", connection))
                {
                    cmd.Parameters.Add(new SqlParameter("CustomerMobileNo", Request.mobile_no));
        ...
        public DataSet APTGetPin_Payout(string retailer_number)
        {
            //default timeout 30 secs
            using (var connection = new SqlConnection(_authconnString))
            {
                connection.Open();
                using (var cmd = new SqlCommand("Apt_getpin", connection))
                {
                    cmd.Parameters.Add(new SqlParameter("Agentmobilenumber", retailer_number));
                    ...
                    {
                        _log.WriteExceptionLog(MethodBase.GetCurrentMethod().Name, ex.Message, ex.StackTrace, retailer_number);
        ...
        public DataSet APTInsertPin_Payout(Insertpin_PayoutRequest Request)
        {
            //default timeout 30 secs
            using (var connection = new SqlConnection(_authconnString))
            {
                connection.Open();
                using (var cmd = new SqlCommand("Apt_inspin", connection))
                {
                    cmd.Parameters.Add(new SqlParameter("Agentmobilenumber", Request.retailer_number));
                    cmd.Parameters.Add(new SqlParameter("pin", Request.new_pin));
                    ...
                    {
                        _log.WriteExceptionLog(MethodBase.GetCurrentMethod().Name, ex.Message, ex.StackTrace, Request.retailer_number);
        ...
        public DataSet APTUpdateKYC_CustomerPayout(APTUpdateCustomerKYCPayoutRequest Request)
        {
            //default timeout 30 secs
            using (var connection = new SqlConnection(_txnconnString))
            {
                connection.Open();
                using (var cmd = new SqlCommand("APT_UpdateApprovalStatus_CustomerPayout", connection))
                {
                    cmd.Parameters.Add(new SqlParameter("TransactionID", Request.transaction_id));
                    cmd.Parameters.Add(new SqlParameter("ApprovalstatusRefID", Request.approval_status));
        ...
        public DataSet APTGetPGtoPayoutTxn(string transactionId)
        {
            //default timeout 30 secs
            using (var connection = new SqlConnection(_txnconnString))
            {
                connection.Open();
                using (var cmd = new SqlCommand("APT_GetTransactionID_CustomerPayout", connection))
                {
